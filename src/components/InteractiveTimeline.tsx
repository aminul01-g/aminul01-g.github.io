        ...
        return (
          <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path
              ...
              strokeLinejoin="round"
              strokeWidth="2"
              d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H8a2 2 0 01-2-2V8a2 2 0 012-2h4a2 2 0 012 2z"
            />
          </svg>
        );
      case 'achievement':
                ...
                <div className={`w-5/12 ${index % 2 === 0 ? 'pr-8' : 'pl-8'}`}>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 mb-3">
                      <div
                        className={`p-2 rounded-full bg-gradient-to-r ${getTypeColor(item.type)} text-white`}
                      >
