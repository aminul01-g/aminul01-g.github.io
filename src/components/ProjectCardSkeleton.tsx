export default function ProjectCardSkeleton(): React.ReactElement {
  return (
    <div className="animate-pulse h-full flex flex-col rounded-xl overflow-hidden glass-card border border-gray-200 dark:border-gray-700 shadow-lg max-w-full">
