...
export default function Post({ post }: { post: BlogPost }) {
  return (
    <>
      <Helmet>
        <title>{post?.title ? `${post.title} | Blog | Aminul Islam Bhuiyan Amin` : 'Blog Post | Aminul Islam Bhuiyan Amin'}</title>
        <meta name="description" content={post?.summary || 'Read this blog post by Aminul Islam Bhuiyan Amin.'} />
        <meta property="og:title" content={post?.title ? `${post.title} | Blog | Aminul Islam Bhuiyan Amin` : 'Blog Post | Aminul Islam Bhuiyan Amin'} />
        <meta property="og:description" content={post?.summary || 'Read this blog post by Aminul Islam Bhuiyan Amin.'} />
