...
import { FaMapMarkerAlt, FaEnvelope, FaPhone, FaGithub, FaLinkedin, FaPython, FaDocker, FaGitAlt, FaLinux, FaDatabase, FaAward, FaRobot, FaGraduationCap, FaCheckCircle, FaFlask, FaDownload } from 'react-icons/fa';
