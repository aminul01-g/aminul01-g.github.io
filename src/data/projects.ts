...
export const projects: Project[] = [
  {
    ...
    description: 'AI-powered study assistant application that helps students learn more effectively using machine learning algorithms to personalize study plans and track progress.',
  ...
  {
    title: 'LearnML',
    description: 'Comprehensive machine learning resources and interactive Jupyter notebooks covering fundamental to advanced ML concepts.',
  ...
  },
  {
    ...
    description: 'End-to-end data science project performing exploratory data analysis and predictive modeling on the Ames Housing dataset.',
    ...
    thumbnail: '🏠',
    demoUrl: 'https://colab.research.google.com/github/aminul01-g/Predictive-Modeling-of-Ames-Housing-Data',
    date: '2023-05-10',
    role: 'Data Scientist'
  },
  {
    title: 'Titanic Survival Prediction',
    description: 'Machine learning model that predicts passenger survival on the Titanic using various classification algorithms.',
  ...
  },
  {
    ...
    description: 'Binary classification model that predicts diabetes risk based on diagnostic measurements.',
  ...
  },
  {
    ...
    description: 'Curated collection of resources, tutorials, and best practices for AI and machine learning engineering.',
