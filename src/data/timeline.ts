...
export const timelineData: TimelineItem[] = [
  {
    ...
    description: 'Currently pursuing my degree in AI Engineering, focusing on machine learning, deep learning, and artificial intelligence applications. Learning cutting-edge technologies and methodologies.',
    date: '2023 - Present',
    type: 'education',
    icon: React.createElement('svg', { className: 'w-6 h-6', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' },
  ...
  },
  {
    ...
    description: 'Developed multiple machine learning projects including predictive modeling, computer vision applications, and natural language processing systems. Implemented various algorithms and frameworks.',
    date: '2023 - Present',
    type: 'experience',
    icon: React.createElement('svg', { className: 'w-6 h-6', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' },
  ...
  },
  {
    ...
    description: 'Completed comprehensive data science and machine learning certifications, covering statistical analysis, data visualization, and predictive modeling techniques.',
    date: '2023',
    type: 'achievement',
    icon: React.createElement('svg', { className: 'w-6 h-6', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' },
  ...
  },
  {
    ...
    description: 'Built modern web applications using React, TypeScript, and Node.js. Created responsive designs with Tailwind CSS and implemented RESTful APIs.',
    date: '2022 - Present',
    type: 'experience',
    icon: React.createElement('svg', { className: 'w-6 h-6', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' },
  ...
  },
  {
    ...
    description: 'Active participant in competitive programming contests, solving algorithmic problems and improving problem-solving skills. Achieved high rankings in various competitions.',
    date: '2022 - Present',
    type: 'achievement',
    icon: React.createElement('svg', { className: 'w-6 h-6', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' },
  ...
  },
  {
    ...
    description: 'Contributed to various open-source projects and created personal projects that demonstrate technical skills and problem-solving abilities. Active in the developer community.',
    date: '2022 - Present',
    type: 'experience',
    icon: React.createElement('svg', { className: 'w-6 h-6', fill: 'none', stroke: 'currentColor', viewBox: '0 0 24 24' },
